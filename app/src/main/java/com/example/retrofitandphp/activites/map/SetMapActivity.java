package com.example.retrofitandphp.activites.map;
...
import com.example.retrofitandphp.activites.LoginActivity;
import com.example.retrofitandphp.activites.MainActivity;
import com.example.retrofitandphp.activites.ProfileActivity;
import com.example.retrofitandphp.api.RetrofitClient;
import com.example.retrofitandphp.models.AddressDtlModel;
...
public class SetMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    String fullAddress, cityName, stateName, countryName1, stEmail, stPassword, stlong, stlati, status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AddressDtlModel addressDtlModel = new AddressDtlModel();
                addressDtlModel.setLng(location1);
                addressDtlModel.setLat(location2);
    ...
    public void getAddress(double myLat, double myLong) throws IOException {
        ...
        Call<DefaultResponse> call = RetrofitClient
                .getInstance()
                .getApi()
                .addAddressFromMap(fullAddress, countryName1, stateName, cityName, String.valueOf(myLong), String.valueOf(myLat));
